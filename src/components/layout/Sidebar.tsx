...
import {
  ...
  Building2, ChevronRight, LogOut, Package, ChevronDown, Target, UserCog, Trash2, Calculator,
} from 'lucide-react'
...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'B2B Campaign',   icon: <Target className="w-4 h-4" />,          path: '/b2b-campaign',    module: 'b2b-campaign' },
  ...
  { label: 'Accounts',       icon: <Calculator className="w-4 h-4" />,      path: '/accounts',        module: 'accounts' },
  ...
  { label: 'Recycle Bin',   icon: <Trash2 className="w-4 h-4" />,          path: '/recycle-bin',     module: 'recycle-bin' },
]
          ...
          return (
            <Link
              ...
              data-tour={
                ...
                item.path === '/settings' ? 'settings' : undefined
              }
              className={cn(
                'sidebar-item',
                isActive ? 'sidebar-item-active' : 'sidebar-item-inactive',
